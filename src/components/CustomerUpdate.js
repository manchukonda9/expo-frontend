...
import styles from '../assets/styles';
 ...
 class CustomerUpdate extends Component {
   ...
   axios.patch("https://eshop-spot-backend.herokuapp.com/customers/me",jusJson,axiosConfig,{
 ...
 componentDidMount (){
    ...
    let axiosConfig = {
     headers: {
      ...
      axios.get("https://eshop-spot-backend.herokuapp.com/customers/me",axiosConfig,{
        withCredentials: true
    }).then(response =>{
