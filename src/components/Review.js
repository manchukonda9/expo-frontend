...
export default function Review(props) {
  ...
  console.log(address, ",,,,", oldCart)
    ...
    const placeOrder = async () => {
      ...
      const hitback =  await axios.get("https://eshop-spot-backend.herokuapp.com/cart/mine",axiosConfig, {
      ...
      axios.post(`https://eshop-spot-backend.herokuapp.com/order/add`,newO,axiosConfig,{
        withCredentials: true })
