...
import styles from '../assets/styles';
 ...
 class VendorUpdate extends Component {
   ...
   axios.patch("https://eshop-spot-backend.herokuapp.com/vendors/me",jusJson,axiosConfig,{
 ...
 componentDidMount (){
    ...
    let axiosConfig = {
     headers: {
      ...
      axios.get("https://eshop-spot-backend.herokuapp.com/vendors/me",axiosConfig,{
        withCredentials: true
    }).then(response =>{
