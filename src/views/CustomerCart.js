    ...
    let axiosConfig = {
     headers: {
      ...
      try{
        ...
        const hitback =  await axios.get("https://eshop-spot-backend.herokuapp.com/customers/myCart",axiosConfig, {
      ...
      axios.get(`https://eshop-spot-backend.herokuapp.com/product/all`,axiosConfig).then(response => {console.log("response" + response.data);
